...
<body>
	<div class="slideanim">
		<nav class="navbar navbar-expand-lg navbar-dark bg-success">
		  ...
		  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
			...
			<form style="padding:20px" class="form-inline my-2 my-lg-0">
	...
	<?php
		...
		$sql = "Select * From posts WHERE username='$currentuser' ORDER BY id DESC";
		...
		if(mysqli_num_rows($res) > 0){
			while($row = mysqli_fetch_assoc($res)){
				...
				<div class='card text-center'>
				  <div class='card-header text-white bg-success mb-8'>
					$username
				  </div>
				  <div class='card-body'>
				  	$image
